...
<a href="admin.php"> VIEW CONTACT FORM</a>
  ...
  <a href="deletecontact.php"  class="active">DELETE CONTACT FORM</a>
...
<div class="main">
  <h2>ADMIN SPACE: </h2>
  <h2>DELETE ANY RECORD FROM THE CONTACT FROM</h2>
  <table id="view">
  <tr>
    <th>ID</th>
    <th>NAME</th>
...
if($conn -> connect_error){
  ...
  if($result -> num_rows > 0){
      while($row = $result -> fetch_assoc()){
          ...
          <td>" . $row["COUNTRY"] . "</td>
          <td>" . $row["SUBJECT"] . "</td>
          <td><a href='delcon.php?rn= $row[ID]'  onclick='return checkdelete()'>Delete</a></td>
          </tr>";
      }
      echo "</table>";
  }
