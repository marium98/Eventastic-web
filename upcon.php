...
<div class="container1">
 ...
 <input class="input-field" type="text" name="country" rows="5" cols="90" placeholder="country" value="<?php echo $_GET['c']; ?>">
  </div>

  <div class="input-container">
    <i class="fa fa-comment icon"></i>
    <input class="input-field" type="text" name="subject" rows="5" cols="90" placeholder="subject" value="<?php echo $_GET['s']; ?>">
 </div>
 ...
 if (isset($_GET['submit'])) {
    ...
    $subject=$_GET['subject'];
      $query = "UPDATE contact set NAME = '$name' ,EMAIL='$email' ,COUNTRY='$country' , SUBJECT='$subject' WHERE ID='$id'";
      $data=mysqli_query($dbcon,$query);
if($data){
    echo "<font color='green'>record update successfully <a href='updatecontact.php'>Check Updated list here</a>'";
}
else{
    echo "<font color='red'>record not update";
      ...
      echo "<font color='black'>click on update button to save the changes";
  }
?> 
</body>
</html>
