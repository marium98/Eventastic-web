...
.margin {margin-bottom: 0px;}
  .bg-1 { 
    ...
    color: white;
    background-image: url("https://rsm-media-cdn-live.azureedge.net/cache/c/9/a/c/1/a/c9ac1aa7cd5a3e4966748efd185d553fa7887d77.jpg");
...
--------------------------------------------------------------------------------------------------------------- */
.btmspace-10{margin-bottom:10px;text-align:left;}
 ...
 <div class="bg-img" style="background-image:url('https://cdn0.weddingwire.ca/img_r_10838/8/3/8/0/t30_50_10838.jpg');"> 
  <header id="header" class="hoc clear"> 
    <div id="logo" class="one_quarter first">
      <h1 style="text-align: left;"><a href="index.html">Eventastics</a></h1>
      <p style="text-align: left;">P P P Pick Up The Event</p>
    </div>
    <div class="three_quarter">
      <ul class="nospace clear">
        ...
        <li class="one_third">
          <div class="block clear"><a href="#"><i class="fa fa-envelope"></i></a> <span><strong>Send us a mail:</strong>younushaniya@gmail.com</span></div>
        </li>
        <li class="one_third">
...
<div class="container">
    ...
    <div class="dropdown-content">
      ...
      <a href="menue.php"><i class="fa fa-cutlery"></i>List of Menu</a>
    </div>
  </div> 
...
<div class="container-fluid bg-1 text-center">
  <h3 class="margin"></h3>
   <h1 style="font-weight: bolder; color: black;">MENUE DETAIL LIST</h1>
   <h2 style="text-align: center; color: black;">ENJOY YOUR DINING EXPERIENCE WITH US</h2> </div> <br><br>
<div class="row">
  <div class="column">
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/delish-cranberry-brie-bites-horizontal-3-1540486092.jpg?crop=1.00xw:0.752xh;0,0.0673xh&resize=480:*" alt="APPETIZER" >
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Chicken Satay</li>
      <li>Chicks Delight</li>
      <li>Mini Spring Roll</li>
      <li>Spicy Chicken Wings</li>
      <li>Garlic Shrimp</li>
      <li>Guyu Kushikatsu</li>
      <li>Fried Nuggets</li>
      <li>Honey Lemon Wings</li>
      <li>Sea Food Wonton</li>
      <li>Turi Tebasaki no Teriyaki</li>
      <li>Gyu Tazukuri</li>
      </ul>
    </div>    
  </div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://www.seriouseats.com/recipes/images/2017/12/20171115-chicken-soup-vicky-wasik-11-1500x1125.jpg" alt="soup">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Hot & Sour Soup (red)</li>
      <li>Chicken Corn Soup</li>
      <li>Hot & Sour Soup (white)</li>
      <li>Tomato Soup</li>
      <li>Misco Soup</li>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://natashaskitchen.com/wp-content/uploads/2019/02/Greek-Salad.jpg" alt="SALAD">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Italian Salad Bars</li>
      <li>Sashmi Salad</li>
      <li>Caesar Salad</li>
      <li>Arabic Salad Bar</li>
      <li>Greek Salad</li>
      </ul>
    </div>   
  </div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://wayofchina.com/wp-content/uploads/2018/01/sichuan_cuisine4.jpg" alt="TRADITIONAL SI-CHUAN FOOD">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Chilli Prawn (Gong Bao)</li>
      <li>Chicken Yanbao</li>
      <li>Chicken Yam-chu</li>
      <li>Chilli Wings</li>
      <li>Beef Chilli Dry</li>
      <li>Chicken Gong Bao</li>
      <li>Spicy Chicken Tofu</li>
      <li>Chicken with Chilli & Bamboo Shoots</li>
      </ul>
    </div>   
  </div>
</div>
<p>TRADITIONAL SI-CHUAN FOOD</p>
</div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://www.unlockfood.ca/EatRightOntario/media/Website-images-resized/Facts-on-seafood-and-fish-allergies-original-resized.jpg" alt="SEA FOOD">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Prawn Tempura</li>
      ...
      <li>Steam Fish</li>
      <li>Finger Fish</li>
      <li>Deep Fried Pullah Fish</li>
      <li>Fish in Lemon Butter Sauce</li>
      <li>Thai Crab</li>
      <li>Sea Food Teppanyaki</li>
      </ul>
    </div>   
  </div>
</div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://cdn-a.william-reed.com/var/wrbm_gb_food_pharma/storage/images/3/2/6/3/773623-1-eng-GB/Beef-and-lamb-exports-to-US-worth-millions-step-closer_wrbm_large.jpg" alt="BEEF & LAMB">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Smoked Bar ‘B.Q’ Steak</li>
      <li>Hawallan Steak</li>
      <li>Beef in Oyster Sauce</li>
      <li>Mashroom Steak</li>
      <li>American Steak</li>
      <li>Pepper Steak</li>
      <li>Beef & Pepper</li>
      <li>Stir Fried Beef and Vegetables</li>
      <li>French Onion Steak</li>
      <li>Steak Tuscany</li>
      <li>Steak Diane</li>
      </ul>
    </div>   
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://s23209.pcdn.co/wp-content/uploads/2019/01/Instant-Pot-Rotisserie-ChickenIMG_8266.jpg" alt="CHICKEN">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>ChickenCheese Fillet</li>
      <li>Chicken Cheese Ball</li>
      <li>Drum Stick</li>
      <li>Chicken Strips</li>
      <li>GChicken Pineapple</li>
      <li>Broasted Chicken</li>
      <li>Chicken Katsu</li>
      <li>Chicken Cashew Nuts</li>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://www.simplyrecipes.com/wp-content/uploads/2016/09/cilantro-lime-rice-horiz-a2-2000.jpg" alt="RICE">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Chicken Fried Rice</li>
      <li>Gyu Yakimeshi</li>
      <li>Mongolian Rice</li>
      <li>Ebi Yakimushi</li>
      <li>Zrishik Pulao</li>
      <li>Sea Food Fried Rice</li>
      <li>apanese Garlic Rice</li>
      <li>Singaporean Rice</li>
      <li>Special Fried Rice</li>
      <li>Vegetable Fried Rice</li>
      <li>chicken Egg Rice</li>
      </ul>
    </div>   
  </div>
</div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://lifemadesimplebakes.com/wp-content/uploads/2015/06/Quick-Easy-Butter-Garlic-Noodles.jpg" alt="PASTA & NOODLES">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Chicken Mushroom Lasagna</li>
      <li>Penne Napolitana</li>
      <li>Pasta Primavera</li>
      <li>SChicken Chowmein</li>
      <li>Penne Arrabiata</li>
      <li>Spaghetti Bolognaise</li>
      <li>Cannellobni Ai Funghi</li>
      <li>Spaghetti in Pesto Sauce</li>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://silverdumbiryani.com/img/dish2.jpg" alt="PAKISTANI & MUGHLAI FOOD">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Sindhi Biryani</li>
      <li>Chicken Handi</li>
      <li>Chicken Hara Masala (Gravy)</li>
      <li>Chicken Makhni</li>
      <li>Qeema Karahi</li>
      <li>Mutton Zafrani Qorma</li>
      <li>Palak Paneer</li>
      <li>Zeera Pulao</li>
      <li>Fish Curry</li>
      <li>Qorma Curry</li>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://ak0.picdn.net/shutterstock/videos/5348600/thumb/1.jpg" alt="BAR B Q">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Chicken Tikka Boti</li>
      <li>Chicken Malai Boti</li>
      <li>Chicken Anarkali Boti</li>
      <li>Chicken Bihari Boti</li>
      <li>Chicken Reshmi Kabab</li>
      <li>Beef Gola Kabab</li>
      <li>Beef Dhaga Kabab</li>
      <li>Stuffed Chicken Breast</li>
      <li>Beef Biharii</li>
      <li>Mutton Sajji</li>
      <li>Beef Afghani Kabab</li>
      </ul>
    </div>   
  </div>
</div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://suebeehomemaker.com/wp-content/uploads/2016/11/french-bread-6.jpg" alt="BREAD">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Milky Naan</li>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDmPfuNy6cFulcWYgsaW4zIGJuP1YhwYM0bo6lyubmtPQXjAib" alt="HI-TEA" >
    </div>
    <div class="flip-box-back">
    <ul>
      ...
      <li>Zinger Burger</li>
      <li>Mini Pizza</li>
      <li>Crispy Fried Chicken Wings</li>
      </ul>
    </div>   
  </div>
</div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://fitfoodiefinds.com/wp-content/uploads/2018/06/key-lime-bars.png" alt="HOT & COLD BEVERAGES">
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Fresh Juices</li>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="https://fitfoodiefinds.com/wp-content/uploads/2018/06/key-lime-bars.png" alt="DESSERTS" >
    </div>
    <div class="flip-box-back">
    <ul>
      <li>Rabri Kheer</li>
      <li>Matka Kulfi</li>
      <li>Mini Hot Gulab Jaman</li>
      <li>Cream Cramel</li>
      <li>Hot Alaska</li>
      <li>Apple Pie</li>
      <li>Lab-e-shereen</li>
