...
<a href="admin.php"> VIEW CONTACT FORM</a>
  ...
  <a href="viewinquiry.php"  class="active">VIEW INQUIRY FORM</a>
...
if($conn -> connect_error){
  ...
  if($result -> num_rows > 0){
      while($row = $result -> fetch_assoc()){
          echo "<tr><td>" . $row["ID"] ."</td><td>" . $row["NAME"] . "</td><td>" . $row["EMAIL"] . "</td><td>" . $row["COMMENTS"] . "</td></tr>";
      }
      echo "</table>";
  }
  else{
