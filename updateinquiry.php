...
<div class="sidebar">
<a href="admin.php"> VIEW CONTACT FORM</a>
  ...
  <a href="updateinquiry.php" class="active">UPDATE INQUIRY FORM</a>
  <a href="deleteinquiry.php">DELETE INQUIRY FORM</a>
</div>

<div class="main">
  <h2>ADMIN SPACE: </h2>
  <h2>UPDATE RECORDS FORM THE INQUIRY FORM</h2>
  <table id="view">
  <tr>
    <th>ID</th>
    <th>NAME</th>
...
if($conn -> connect_error){
  ...
  $sql = "select ID , NAME ,EMAIL ,COMMENTS FROM inquiry";
  ...
  if($result -> num_rows > 0){
      while($row = $result -> fetch_assoc()){
          ...
          <td>" . $row["EMAIL"] . "</td>
          <td>" . $row["COMMENTS"] . "</td>
          <td><a href='upin.php?rn= $row[ID] &em= $row[NAME]  &e=$row[EMAIL] &c=$row[COMMENTS]'> Update</a></td>
          </tr>";
      }
      echo "</table>";
  }
