...
<a href="admin.php"> VIEW CONTACT FORM</a>
  ...
  <a href="deleteinquiry.php" class="active">DELETE INQUIRY FORM</a>
  <a href="logout.php">LOG OUT?</a>
</div>

<div class="main">
  <h2>ADMIN SPACE: </h2>
  <h2>DELETE ANY INQUIRY FROM THE LIST BELOW</h2>
  <table id="view">
  <tr>
    <th>ID</th>
    <th>NAME</th>
...
if($conn -> connect_error){
  ...
  if($result -> num_rows > 0){
      while($row = $result -> fetch_assoc()){
          ...
          <td>" . $row["EMAIL"] . "</td>
          <td>" . $row["COMMENTS"] . "</td>
          <td><a href='delin.php?rn= $row[ID]'  onclick='return checkdelete()'>Delete</a></td>
          </tr>";
      }
      echo "</table>";
  }
